...
app_pivot['Total'] = app_pivot.A + app_pivot.B
print app_pivot
...
app_pivot['Percent with Applications'] = app_pivot.A / app_pivot.Total
print app_pivot
...
just_apps = df[df.is_application == 'A']
print just_apps
...
ax = plt.subplot()
plt.bar(range(len(app_pivot)), app_pivot['Percent with Applications'].values)
